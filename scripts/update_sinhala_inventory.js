...
const products = [
  { id: 1, name: 'කීරි සම්බා සහල් 5kg', expiry: '2027-02-28' },
  { id: 2, name: 'නැවුම් කිරි 1L', expiry: '2026-05-27' },
  { id: 3, name: 'මන්චි ක්‍රීම් ක්‍රැකර් 190g', expiry: '2026-11-15' },
  { id: 4, name: 'කොකා කෝලා 1.5L', expiry: '2026-09-30' },
  { id: 5, name: 'රතු ලූනු 1kg', expiry: '2026-06-05' },
  { id: 6, name: 'ඇන්කර් කිරි පිටි 400g', expiry: '2027-01-20' },
  { id: 7, name: 'ඇස්ට්‍රා මාගරින් 250g', expiry: '2026-08-18' },
  { id: 8, name: 'ලයිෆ්බෝයි සබන් 100g', expiry: '2028-03-31' },
  { id: 9, name: 'සන්සිල්ක් ෂැම්පු 180ml', expiry: '2028-12-31' },
  { id: 10, name: 'සිලෝන් තේ 200g', expiry: '2027-04-30' }
];
